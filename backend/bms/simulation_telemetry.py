...
_EXTRA: Dict[str, Tuple[str, Optional[str], float]] = {
    ...
    "AHU-01.ReturnAirRH": ("AHU-01", "%", 48.0),
    "AHU-01.CoolingValve": ("AHU-01", "%", 12.0),
    "CHILLER1.CompressorPower": ("CH-01", "kW", 42.0),
    ...
    "ACC.FanPower": ("CH-01", "kW", 12.5),
    "ACC.CompressorPower": ("CH-01", "kW", 38.0),
    "ACC.Load": ("CH-01", "%", 68.0),
    ...
    "CW.PumpPower": ("P-01", "kW", 8.5),
    "CW.HeadPressureSetpoint": ("CH-01", "kPa", 1150.0),
    "CW.Load": ("CH-01", "%", 68.0),
    "CW.OAT": ("SITE", "°C", 26.1),
