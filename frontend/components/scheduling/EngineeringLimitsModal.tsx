...
export const EngineeringLimitsModal: React.FC<EngineeringLimitsModalProps> = ({ isOpen, onClose }) => {
  ...
  const titleId = 'engineering-limits-title';
  ...
  return (
    ...
    >
      <div
        ...
        className="bg-slate-900 border border-slate-700 rounded-2xl max-w-2xl w-full p-6 shadow-2xl space-y-5 max-h-[90vh] overflow-y-auto outline-none"
      >
        <div className="flex items-center justify-between border-b border-slate-800 pb-3">
          <h2 id={titleId} className="text-base font-bold text-slate-100">
            Engineering limits & safety constraints
          </h2>
